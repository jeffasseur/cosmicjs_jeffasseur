          ...
          <div className="relative m-auto flex max-w-7xl flex-col items-start gap-2">
            ...
            <div className="py-4 flex flex-col lg:flex-row lg:items-end lg:justify-between lg:gap-12 lg:mb-6 lg:py-10 w-full">
              <div className="flex flex-col gap-2 lg:gap-6">
                ...
                <span className="font-extrabold text-light-50 text-sm">{date}</span>
                <h1 className="text-3xl font-bold leading-tight tracking-tighter text-primary w-full dark:text-white sm:text-4xl md:text-5xl dark:font-semibold dark:tracking-tight">
                  {blog.title}
                </h1>
