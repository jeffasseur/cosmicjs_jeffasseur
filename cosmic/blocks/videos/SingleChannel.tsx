  ...
  try {
    ...
    return (
      <div className={className}>
        <div className="mb-6 w-full max-h-[500px] overflow-hidden">
          <img
        ...
        <section className="px-4 md:px-8 max-w-[1650px] m-auto relative -top-[55px] h-auto">
        ...
        <div className="flex items-center mb-6 border-b dark:border-gray-800 pb-4 -mt-16"></div>
        <section className="px-4 mb-8 md:px-8 max-w-2xl m-auto relative">
          <h2 className="text-2xl font-semibold mb-4 text-black dark:text-white">
            About
          </h2>
          <div
            className="space-y-4 text-zinc-700 dark:text-zinc-300 *:[li]:disc"
            dangerouslySetInnerHTML={{ __html: channel.metadata.description }}
          />
        </section>
        <section className="px-4 md:px-8 mb-10 max-w-[1650px] m-auto">
          <h2 className="mb-4 text-center text-4xl font-bold leading-tight tracking-tighter text-dark-90 dark:text-light-90">
            Videos
          </h2>
          <VideoList
